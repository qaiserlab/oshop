            ...
            :options="{ filterable: false }">
              <template slot="invoice" scope="props">
                <div style="float: left">
                  ...
                  <br>
                  <b>Total Qty:</b> {{ props.row.totalItems }} |
                  <b>Total:</b> {{ props.row.total_ }}<br>
                  <br>
                  <b>Tanggal Konfirmasi:</b> {{ props.row.confirm.confirmDate_ }}<br>
                  <b>Jumlah Transfer:</b> {{ props.row.confirm.amount_ }}<br>

                  <!--
                    <b>Bank Pengirim:</b> {{ props.row.confirm.bankSender }} |
                    <b>Bank Tujuan:</b> {{ props.row.confirm.bankDestination }}<br>
                  -->
                </div>

                <div style="float: right">
                  <ui-link :href="'#/member-confirmed-order/view-data/' + props.row._id">
                    {{ props.row.code }}
                  </ui-link><br>
              ...
              <!-- <template slot="code" scope="props">
                <ui-link :href="'#/confirmed-order/view-data/' + props.row._id">
                  {{ props.row.code }}
                </ui-link>
              </template> -->
            </v-client-table>
