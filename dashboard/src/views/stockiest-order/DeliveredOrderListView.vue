            ...
            :options="{ filterable: false }">
              <template slot="invoice" scope="props">
                <div style="float: left">
                  <b>Member:</b> {{ props.row.memberId }}/{{ props.row.member.fullName }}<br>
                  <b>No. Resi:</b> {{ props.row.resi }}<br>
                  <br>
                ...
                <div style="float: right">
                  <ui-link :href="'#/delivered-order/view-data/' + props.row._id">
                    {{ props.row.code }}
                  </ui-link><br>
              ...
              <!-- <template slot="code" scope="props">
                <ui-link :href="'#/expired-order/view-data/' + props.row._id">
                  {{ props.row.code }}
                </ui-link>
              </template> -->
            </v-client-table>
