<template>
  <main-layout>
          ...
          <ui-col size="md-12">
            ...
            :options="{ filterable: false }">
              <template slot="gambar" scope="props">
                <img :src="props.row.image_" alt="" style="width: 320px">
              </template>
              <template slot="aksi" scope="props">
                <div>
                  <b>Title: </b>{{ props.row.title }}<br>
                  <b>PostedOn: </b>{{ props.row.postedOn_ }}<br>
                </div>
                <div>
                  <ui-link :href="'#/banner/edit-data/' + props.row._id" icon="edit">Ubah</ui-link>
    ...
    <ui-buttonbar>
      ...
      <ui-button href="#/banner/add-new-data" icon="plus"></ui-button>
    </ui-buttonbar>
