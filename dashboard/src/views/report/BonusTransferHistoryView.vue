<template>
  <main-layout>
    ...
    <section class="content-header">
      <h1>
        Laporan Riwayat Transfer Bonus
      </h1>
      <ol class="breadcrumb">
        <li>
          <a href="#/">
      ...
      <ui-panel title="List" :loading="loading" icon="table">
        ...
        <ui-row form-group>
          <ui-col size="md-12">
            ...
            :columns="['member_ID', 'tanggal', 'debit', 'kredit', 'saldo', 'keterangan']">
            </v-client-table>
  ...
  export default {
    ...
    ************************/
    computed: {
      ...
      <id="_mapGetters">
      ************************/
      ...mapGetters('BonusTransferHistoryStore', {
        rs: 'rs',
        rowActive: 'rowActive',
      }),
    ...
    ************************/
    methods: {
      ...
      <id="_mapActions">
      ************************/
      ...mapActions('BonusTransferHistoryStore', {
        fetchData: 'fetchData',
        moveData: 'moveData',
      }),
