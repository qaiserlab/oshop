      ...
      <ui-panel title="List" :loading="loading" icon="table">
        ...
        <ui-row form-group>
          <ui-col size="md-12">
            ...
            :columns="['parent', 'judul', 'publikasi', 'aksi']"
            :options="tableOptions">
              <template slot="background" scope="props">
                <img :src="props.row.image_" alt="" style="width: 240px">
              </template>
              <!-- <template slot="info" scope="props">
                <span v-if="props.row.parent">
                  <b>Parent:</b> {{ props.row.parent }}<br>
                </span>
                <b>Title:</b> {{ props.row.title }}<br>
                <b>Publication:</b> {{ props.row.publication }}
              </template> -->
              <template slot="aksi" scope="props">
                <!-- <div style="text-align: center">
                  <img :src="props.row.image_" alt="" style="height: 60px">
                </div>
                <hr> -->
                <div>
                  <ui-link :href="'#/product/categories/edit-data/' + props.row._id" icon="edit">Ubah</ui-link>
    ...
    data() {
      return {
        ...
        tableOptions: {
          ...
          filterable: ['parent', 'judul', 'publikasi'],
        },
      };
    },
