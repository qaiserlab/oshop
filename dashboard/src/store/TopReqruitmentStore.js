  ...
  actions: {
    ...
    fetchData({ commit }, data) {
      ...
      return new Promise((resolve, reject) => {
        api.get('report/top-reqruitment', data).then(result => {
    ...
    createData({ commit }, data) {
      return new Promise((resolve, reject) => {
        ...
        api.post('report/top-reqruitment', data).then(result => {
          if (result.state == 'success') {
    ...
    updateData({ state, commit }, data) {
      return new Promise((resolve, reject) => {
        ...
        api.put('top-reqruitment/' + state.rowActive._id, data).then(result => {
          if (result.state == 'success') {
    ...
    deleteData({ state, commit }, id) {
      return new Promise((resolve, reject) => {
        api.delete('top-reqruitment/' + state.rowActive._id).then(result => {
          if (result.state == 'success')
            resolve(result);
          else
            reject(result);
  ...
  getters: {
    ...
    rs(state) {
      return state.rs.map(row => {
        ...
        row.member_Disponsori = row.sponsoredMember;
