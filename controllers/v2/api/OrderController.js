...
//   Model.find({ stockiestId: '' }).then(data => {
//     res.json({
//       state: 'success',
...
************************/
router.get('/confirmed', authMiddleware, async (req, res, next) => {
  var stockiestId = req.decoded.memberId
  var status = 'Confirmed';

  var rsOrder = await Model.find({
    stockiestId,
    status,
  });
...
************************/
router.get('/paid', authMiddleware, async (req, res, next) => {
  var stockiestId = req.decoded.memberId
  var status = 'Paid';
...
************************/
router.get('/processed', authMiddleware, async (req, res, next) => {
  var stockiestId = req.decoded.memberId
...
************************/
router.get('/delivered', authMiddleware, async (req, res, next) => {
  var stockiestId = req.decoded.memberId
...
************************/
router.post('/member-order', authMiddleware, validateMemberOrder, async (req, res, next) => {
  var data = req.body;
...
************************/
router.post('/order-stockiest', authMiddleware, validateOrderStockiest, async (req, res, next) => {
  var data = req.body;
...
function confirm()
************************/
router.put('/confirm', authMiddleware, async (req, res, next) => {
  var data = req.body;
...
************************/
router.put('/change-state/:code', authMiddleware, async (req, res, next) => {
...
************************/
router.delete('/stockiest-order/:id', authMiddleware, (req, res, next) => {
  var id = req.params.id;
...
function state()
************************/
router.put('/state/:id', authMiddleware, async (req, res, next) => {
  var id = req.params.id;
  var data = req.body;
  var status = data.status;
