...
/************************
function getStockiestProductSales()
************************/
router.get('/stockiest/product-sales', authMiddleware, async (req, res, next) => {
  ...
  var rsOrder = await OrderModel.find({
    stockiestId: req.decoded.memberId,
    orderDate: {
      $gte: from,
      $lt: to,
    },
...
/************************
function getStockiestProductPurchase()
************************/
router.get('/stockiest/product-purchase', authMiddleware, async (req, res, next) => {
...
/************************
function getStockiestBestSeller()
************************/
router.get('/stockiest/best-seller', authMiddleware, async (req, res, next) => {
...
************************/
router.getAsync('/product-sales', authMiddleware, async (req, res, next) => {
...
************************/
router.getAsync('/stockiest-product-stock', authMiddleware, async (req, res, next) => {
...
************************/
router.getAsync('/stockiest-sales', authMiddleware, async (req, res, next) => {
...
************************/
router.getAsync('/stockiest-purchase', authMiddleware, async (req, res, next) => {
...
************************/
router.getAsync('/best-seller-product', authMiddleware, async (req, res, next) => {
...
************************/
router.getAsync('/top-buyer', authMiddleware, async (req, res, next) => {
...
************************/
router.getAsync('/top-reqruitment', authMiddleware, async (req, res, next) => {
...
************************/
router.getAsync('/bonus-transfer-history', authMiddleware, async (req, res, next) => {
  var memberId = req.query.memberId;
  var fromDate = req.query.fromDate;
  var toDate = req.query.toDate;
...
************************/
router.getAsync('/serial-number-stock', authMiddleware, async (req, res, next) => {
  var memberId = req.query.memberId;
  var monthYear = req.query.monthYear;
